  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      if (res.status === 201) {
        ...
        await axios.post('http://localhost:5001/api/send-payment', { patientName, patientEmail, doctorName, consultationFee, consultationLink: zLink, isVirtual, appointmentDate });
